<div align="center">
<h2 align="center">Travel Website using Typescript</h2>
<br />
...
1. **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/Thanvi0106/TRAVEL-WEBSITE-USING-TYPESCRIPT
    ```

2. **Navigate to the project folder:**

    ```bash
    cd TRAVEL-WEBSITE-USING-TYPESCRIPT
    ```
